...
import { getEventDate } from "@/lib/event-utils";
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", textAlign: "left", gap: 22, maxWidth: 700 }}>
            <h3
              ...
              style={{ fontFamily: "Syne,sans-serif", fontWeight: 800, fontSize: "clamp(25px,4vw,56px)", lineHeight: 1.05, color: "#fff" }}
            >
            ...
            <div className="anim-up s3" style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "flex-start" }}>
            ...
            <div className="anim-up s4" style={{ display: "flex", gap: 48, marginTop: 16, flexWrap: "wrap", justifyContent: "flex-start" }}>
              {[
                ...
                >
                  <div style={{ position: "relative", height: 190, background: "rgba(15,23,42,0.06)" }}>
                    ...
                    <div style={{ position: "absolute", left: 12, top: 12 }}>
                      <div style={{ background: "rgba(255,255,255,0.80)", border: "1px solid rgba(15,23,42,0.08)", backdropFilter: "blur(10px)", borderRadius: 10, padding: "6px 10px", textAlign: "center", minWidth: 54 }}>
        ...
        >
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 30 }}>
              <span style={{ fontSize: 18, color: "#0f172a", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 700 }}>
                Hamkor tashkilotlar
              </span>
              <h2 style={{ fontWeight: 800, fontSize: "clamp(20px,3vw,50px)", color: "#0f172a", marginTop: 8 }}>
                {t("home.trustedLinks")}
              </h2>
            </div>

            {/* ── Desktop / Tablet: 3 ta keng card grid ── */}
            <div
              className="orgs-grid"
              ...
              {orgs.map((org: any) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 20px 48px rgba(2,6,23,0.13)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "none";
                    e.currentTarget.style.boxShadow = "0 12px 30px rgba(2,6,23,0.08)";
                  }}
                >
                  <img
                    src={org.logo} alt={org.name} loading="lazy"
                  ...
                  <div key={org.id} style={{ flex: "0 0 clamp(140px, 60vw, 220px)" }}>
                    <a
                      ...
                      style={{
                        ...
                        textAlign: "center", textDecoration: "none",
                        boxShadow: "0 12px 30px rgba(2,6,23,0.08)", height: 155,
                      }}
                    >
      ...
      <footer style={{ background: "#0f172a", color: "#fff", padding: "48px 24px 28px", marginTop: 0 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 36, marginBottom: 40 }}>
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 13, color: "#e2e8f0", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 16 }}>
                Havolalar
              </div>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: 14, color: "#94a3b8" }}>
                ...
                <a href="mailto:info@tripday.uz" style={{ color: "#94a3b8", textDecoration: "none" }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = "#fff")}
                  onMouseLeave={(e) => (e.currentTarget.style.color = "#94a3b8")}>
                  ✉️ info@tripday.uz
                </a>
                <a href="https://t.me/tripday_uz" target="_blank" rel="noopener noreferrer"
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 22, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            <span style={{ fontSize: 13, color: "#475569" }}>
              © {new Date().getFullYear()} TripDay. Barcha huquqlar himoyalangan.
            </span>
